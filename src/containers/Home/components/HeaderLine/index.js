          ...
          <Slider {...settings}>
           {
             dataSource.map((section,index) => {
               return (
                 <a key={index} className='headline__sliderInner' href={section.url}> 
                   <div className='headline__sliderTitle'>{section.title}</div>
                   <div className='headline__sliderImgWrapper'>
                     <img className='headline__sliderImg' src={section.pic}></img>
                   </div>
                 </a>
               )
             })
